...
public class ZeKolHakesemActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ze_kol_hakesem);
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(ZeKolHakesemActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("ז") && char2.equals("ה") && char3.equals("כ") && char4.equals("ל") && char5.equals("ה") && char6.equals("ק") && char7.equals("ס") && char8.equals("ם")) {
                    done = true;
                    ...
                    Intent intent = new Intent(ZeKolHakesemActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "Y6DvHs4g8yc");
