...
public class SigaliotActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sigaliot);
//
...
//        animationDrawable.start();
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(SigaliotActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("ס") && char2.equals("י") && char3.equals("ג") && char4.equals("ל") && char5.equals("י") && char6.equals("ו") && char7.equals("ת")) {
                    done=true;
                    ...
                    Intent intent = new Intent(SigaliotActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "mHndiWsfc2U");
