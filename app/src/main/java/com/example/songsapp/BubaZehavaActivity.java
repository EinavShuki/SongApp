...
public class BubaZehavaActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buba_zehava);
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(BubaZehavaActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("ב") && char2.equals("ו") && char3.equals("ב") && char4.equals("ה") && char5.equals("ז") && char6.equals("ה") && char7.equals("ב") && char8.equals("ה")) {
                    done=true;
                    ...
                    Intent intent = new Intent(BubaZehavaActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "kuSUPQsfHQk");
