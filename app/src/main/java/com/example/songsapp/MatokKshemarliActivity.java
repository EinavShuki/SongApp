...
public class MatokKshemarliActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.matok_kshemarli);
...
//        animationDrawable.start();
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(MatokKshemarliActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("מ") && char2.equals("ת") && char3.equals("ו") && char4.equals("ק") && char5.equals("כ") && char6.equals("ש") && char7.equals("מ") && char8.equals("ר") && char9.equals("ל") && char10.equals("י")) {
                    done = true;
                    ...
                    Intent intent = new Intent(MatokKshemarliActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "IZkYWP0esrI");
    ...
    protected void onPause() {
        ...
        if (done) {
            ...
            editor.putBoolean("l9_ready", true);
            editor.apply();
