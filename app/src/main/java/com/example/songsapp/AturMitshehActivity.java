...
public class AturMitshehActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.atur_mitsheh);
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(AturMitshehActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("ע") && char2.equals("ט") && char3.equals("ו") && char4.equals("ר") && char5.equals("מ") && char6.equals("צ") && char7.equals("ח") && char8.equals("ך")) {
                    done = true;
                    ...
                    Intent intent = new Intent(AturMitshehActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "wcayUsa9yvw");
