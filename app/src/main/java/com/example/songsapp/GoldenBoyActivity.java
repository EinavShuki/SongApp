...
public class GoldenBoyActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.golden_boy);
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(GoldenBoyActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("ג") && char2.equals("ו") && char3.equals("ל") && char4.equals("ד") && char5.equals("ן") && char6.equals("ב") && char7.equals("ו") && char8.equals("י")) {
                    done=true;
                    ...
                    Intent intent = new Intent(GoldenBoyActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "NdxOCTezeTg");
