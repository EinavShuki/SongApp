...
public class ShabatBabokerActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shabat_baboker);
...
//        animationDrawable.start();
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(ShabatBabokerActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("ש") && char2.equals("ב") && char3.equals("ת") && char4.equals("ב") && char5.equals("ב") && char6.equals("ו") && char7.equals("ק") && char8.equals("ר")) {
                    done=true;
                    ...
                    Intent intent = new Intent(ShabatBabokerActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "MGAjlqg5URg");
