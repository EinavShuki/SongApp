...
public class HazmanaLeHatunaActivity extends ToastDialogFun implements View.OnClickListener {


    EditText c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11;
    boolean firstFocus = true;
    boolean l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hazmana_lehatuna);
...
//        animationDrawable.start();
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(HazmanaLeHatunaActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.clear:
                ...
                c10.setText("");
                c11.setText("");
                l1 = l2 = l3 = l4 = l5 = l6 = l7 = l8 = l9 = l10 = l11 = false;
                break;
            case R.id.reveal:
                if (oka) {
                    oka = false;
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("ה") && char2.equals("ז") && char3.equals("מ") && char4.equals("נ") && char5.equals("ה") && char6.equals("ל") && char7.equals("ח") && char8.equals("ת") && char9.equals("ו") && char10.equals("נ") && char11.equals("ה")) {
                    done=true;
                    ...
                    Intent intent = new Intent(HazmanaLeHatunaActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "WsX-bejS6EU");
