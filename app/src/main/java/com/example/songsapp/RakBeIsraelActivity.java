...
public class RakBeIsraelActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rak_be_israel);
...
//        animationDrawable.start();
        ...
        c2.setOnFocusChangeListener((v, hasFocus) -> {
            if (hasFocus) {
                ...
                c2.setOnKeyListener((v17, keyCode, event) -> {
        ...
        c3.setOnFocusChangeListener((v, hasFocus) -> {
            if (hasFocus) {
                ...
                //moving back to previous editText
                c3.setOnKeyListener((v14, keyCode, event) -> {
                    if (keyCode == KeyEvent.KEYCODE_DEL) {
                        c3.setOnKeyListener((v141, keyCode16, event16) -> {
        ...
        c4.setOnFocusChangeListener((v, hasFocus) -> {
            if (hasFocus) {
                ...
                //moving back to previous editText
                c4.setOnKeyListener((v15, keyCode, event) -> {
                    if (keyCode == KeyEvent.KEYCODE_DEL) {
                        c4.setOnKeyListener((v151, keyCode14, event14) -> {
        ...
        c5.setOnFocusChangeListener((v, hasFocus) -> {
            if (hasFocus) {
                ...
                //moving back to previous editText
                c5.setOnKeyListener((v13, keyCode, event) -> {
                    if (keyCode == KeyEvent.KEYCODE_DEL) {
                        c5.setOnKeyListener((v131, keyCode12, event12) -> {
        ...
        c6.setOnFocusChangeListener((v, hasFocus) -> {
            if (hasFocus) {
                ...
                //moving back to previous editText
                c6.setOnKeyListener((v12, keyCode, event) -> {
                    if (keyCode == KeyEvent.KEYCODE_DEL) {
                        c6.setOnKeyListener((v121, keyCode13, event13) -> {
        ...
        c7.setOnFocusChangeListener((v, hasFocus) -> {
            if (hasFocus) {
                ...
                c7.setOnKeyListener((v16, keyCode, event) -> {
                    if (keyCode == KeyEvent.KEYCODE_DEL) {
                        c7.setOnKeyListener((v161, keyCode15, event15) -> {
        ...
        c8.setOnFocusChangeListener((v, hasFocus) -> {
            ...
            if (hasFocus) {
                ...
                //moving back to previous editText
                c8.setOnKeyListener((v18, keyCode, event) -> {
                    if (keyCode == KeyEvent.KEYCODE_DEL) {
                        c8.setOnKeyListener((v181, keyCode17, event17) -> {
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(RakBeIsraelActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("ר") && char2.equals("ק") && char3.equals("ב") && char4.equals("י") && char5.equals("ש") && char6.equals("ר") && char7.equals("א") && char8.equals("ל")) {
                    done=true;
                    ...
                    Intent intent = new Intent(RakBeIsraelActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "H19LanB-eEg");
