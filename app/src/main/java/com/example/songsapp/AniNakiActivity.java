...
public class AniNakiActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ani_naki);
...
//        animationDrawable.start();
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(AniNakiActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("א") && char2.equals("נ") && char3.equals("י") && char4.equals("נ") && char5.equals("ק") && char6.equals("י")) {
                    done=true;
                    ...
                    Intent intent = new Intent(AniNakiActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "FqtluwhNts8");
