...
public class AfunaVeGezerActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.afuna_ve_gezer);
...
//        animationDrawable.start();
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(AfunaVeGezerActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("א") && char2.equals("פ") && char3.equals("ו") && char4.equals("נ") && char5.equals("ה") && char6.equals("ו") && char7.equals("ג") && char8.equals("ז") && char9.equals("ר")) {
                    done = true;
                    ...
                    Intent intent = new Intent(AfunaVeGezerActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "5ITUOnDoS2c");
