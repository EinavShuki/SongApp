...
public class AtVaAniActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.at_va_ani);
...
//        animationDrawable.start();
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(AtVaAniActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("א") && char2.equals("ת") && char3.equals("ו") && char4.equals("א") && char5.equals("נ") && char6.equals("י")) {
                    done=true;
                    ...
                    Intent intent = new Intent(AtVaAniActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "d3TFI_2G52M");
