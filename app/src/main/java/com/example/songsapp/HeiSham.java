...
public class HeiSham extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hei_sham);
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(HeiSham.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("א") && char2.equals("י") && char3.equals("ש") && char4.equals("ם")) {
                    done=true;
                    ...
                    Intent intent = new Intent(HeiSham.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "tl5PpPzYcAA");
