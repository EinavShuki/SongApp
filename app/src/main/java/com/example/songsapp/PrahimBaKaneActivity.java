...
public class PrahimBaKaneActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.prahim_ba_kane);
...
//        animationDrawable.start();
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(PrahimBaKaneActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("פ") && char2.equals("ר") && char3.equals("ח") && char4.equals("י") && char5.equals("ם") && char6.equals("ב") && char7.equals("ק") && char8.equals("נ") && char9.equals("ה")) {
                    done=true;
                    ...
                    Intent intent = new Intent(PrahimBaKaneActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "EwvAywMw93M");
