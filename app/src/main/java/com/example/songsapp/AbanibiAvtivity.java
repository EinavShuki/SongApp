...
public class AbanibiAvtivity extends ToastDialogFun implements View.OnClickListener {
...
//        animationDrawable.start();
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(AbanibiAvtivity.this, R.raw.btn_c);
        btnClick.start();
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("א") && char2.equals("ב") && char3.equals("נ") && char4.equals("י") && char5.equals("ב") && char6.equals("י")) {
                    ...
                    Intent intent = new Intent(AbanibiAvtivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "WiyF9tv2ocs");
