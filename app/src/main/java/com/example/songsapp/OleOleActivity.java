...
public class OleOleActivity extends ToastDialogFun  implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ole_ole);
//
...
//        animationDrawable.start();
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(OleOleActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("ע") && char2.equals("ו") && char3.equals("ל") && char4.equals("ה") && char5.equals("ע") && char6.equals("ו") && char7.equals("ל") && char8.equals("ה")) {
                    done=true;
                    ...
                    Intent intent = new Intent(OleOleActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "-OghjORmrRY");
