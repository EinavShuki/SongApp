...
public class ShutiShutiActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shuti_shuti);
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(ShutiShutiActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("ש") && char2.equals("ו") && char3.equals("ט") && char4.equals("י") && char5.equals("ש") && char6.equals("ו") && char7.equals("ט") && char8.equals("י") && char9.equals("ס") && char10.equals("פ") && char11.equals("י") && char12.equals("נ") && char13.equals("ת") && char14.equals("י")) {
                    done=true;
                    ...
                    Intent intent = new Intent(ShutiShutiActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "34YPRRcHOwo");
    ...
    protected void onPause() {
        ...
        if (done) {
            ...
            editor.putBoolean("l8_ready", true);
            editor.apply();
