...
public class OlaHamanginaActivity extends ToastDialogFun implements View.OnClickListener {


    EditText c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14, c15;
    boolean firstFocus = true;
    boolean l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13, l14, l15;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ola_hamangina);
...
//        animationDrawable.start();
        ...
        c14.setOnFocusChangeListener((v, hasFocus) -> {
            if (hasFocus) {
                ...
                //moving back to previous editText
                c14.setOnKeyListener((v114, keyCode, event) -> {
                    if (keyCode == KeyEvent.KEYCODE_DEL) {
                        c14.setOnKeyListener((v1141, keyCode110, event110) -> {
                            if (keyCode110 == KeyEvent.KEYCODE_DEL) {
                                c13.requestFocus();
                            }
                            return false;
                        });
            ...
            c14.addTextChangedListener(new TextWatcher() {
                @Override
                public void beforeTextChanged(CharSequence s, int start, int count, int after) {
        ...
        c15.setOnFocusChangeListener((v, hasFocus) -> {
            ...
            if (hasFocus) {
                ...
                //moving back to previous editText
                c15.setOnKeyListener((v115, keyCode, event) -> {
                    if (keyCode == KeyEvent.KEYCODE_DEL) {
                        c15.setOnKeyListener((v1151, keyCode111, event111) -> {
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(OlaHamanginaActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.clear:
                ...
                c14.setText("");
                c15.setText("");
                l1 = l2 = l3 = l4 = l5 = l6 = l7 = l8 = l9 = l10 = l11 = l12 = l13 = l14 = l15 = false;
                ;
                break;
            case R.id.reveal:
                if (oka) {
            ...
            case R.id.check_btn:
                ...
                String char15 = c15.getText().toString();

                if (char1.equals("ת") && char2.equals("מ") && char3.equals("י") && char4.equals("ד") && char5.equals("ע") && char6.equals("ו") && char7.equals("ל") && char8.equals("ה") && char9.equals("ה") && char10.equals("מ") && char11.equals("נ") && char12.equals("ג") && char13.equals("י") && char14.equals("נ") && char15.equals("ה")) {
                    done=true;
                    ...
                    Intent intent = new Intent(OlaHamanginaActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "5CjPisRG5aE");
    ...
    protected void onPause() {
        ...
        if (done) {
            ...
            editor.putBoolean("l4_ready", true);
            editor.apply();
