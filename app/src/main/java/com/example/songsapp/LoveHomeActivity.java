...
public class LoveHomeActivity extends Activity implements View.OnClickListener {
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(LoveHomeActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case (R.id.lev1):
                intent = new Intent(LoveHomeActivity.this, ParparimLevanimActivity.class);
                startActivityForResult(intent, L1);
                break;
            case (R.id.lev2):
                intent = new Intent(LoveHomeActivity.this, SigaliotActivity.class);
                startActivityForResult(intent, L2);
                break;
            case (R.id.lev3):
                intent = new Intent(LoveHomeActivity.this, HazmanaLeHatunaActivity.class);
                startActivityForResult(intent, L3);
                break;
            case (R.id.lev4):
                intent = new Intent(LoveHomeActivity.this, ZeKolHakesemActivity.class);
                startActivityForResult(intent, L4);
                break;
            case (R.id.lev5):
                intent = new Intent(LoveHomeActivity.this, ShirAhavaIndianiActivity.class);
                startActivityForResult(intent, L5);
                break;
            case (R.id.lev6):
                intent = new Intent(LoveHomeActivity.this, MemaamakimActivity.class);
                startActivityForResult(intent, L6);
                break;
            case (R.id.lev7):
                intent = new Intent(LoveHomeActivity.this, AturMitshehActivity.class);
                startActivityForResult(intent, L7);
                break;
            case (R.id.lev8):
                intent = new Intent(LoveHomeActivity.this, MatokKshemarliActivity.class);
                startActivityForResult(intent, L8);
                break;
            case (R.id.lev9):
                intent = new Intent(LoveHomeActivity.this, HaimSheliActivity.class);
