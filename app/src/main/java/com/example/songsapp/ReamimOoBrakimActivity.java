...
public class ReamimOoBrakimActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.reamim_oo_brakim);
...
//        animationDrawable.start();
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(ReamimOoBrakimActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("ר") && char2.equals("ע") && char3.equals("מ") && char4.equals("י") && char5.equals("ם") && char6.equals("ו") && char7.equals("ב") && char8.equals("ר") && char9.equals("ק") && char10.equals("י") && char11.equals("ם")) {
                    done=true;
                    ...
                    Intent intent = new Intent(ReamimOoBrakimActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "eFbi_zc3TWQ");
