...
public class ParparimLevanimActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.parparim_levanim);
...
//        animationDrawable.start();
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(ParparimLevanimActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("פ") && char2.equals("ר") && char3.equals("פ") && char4.equals("ר") && char5.equals("י") && char6.equals("ם") && char7.equals("ל") && char8.equals("ב") && char9.equals("נ") && char10.equals("י") && char11.equals("ם")) {
                    done=true;
                    ...
                    Intent intent = new Intent(ParparimLevanimActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "hSfvAKQUOzM");
