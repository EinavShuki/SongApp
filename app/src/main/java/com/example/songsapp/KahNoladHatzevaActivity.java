...
public class KahNoladHatzevaActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kah_nolad_htzeva);
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(KahNoladHatzevaActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("כ") && char2.equals("ך") && char3.equals("נ") && char4.equals("ו") && char5.equals("ל") && char6.equals("ד") && char7.equals("ה") && char8.equals("צ") && char9.equals("ב") && char10.equals("ע")) {
                    done=true;
                    ...
                    Intent intent = new Intent(KahNoladHatzevaActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "LGXWvzvrXqM");
