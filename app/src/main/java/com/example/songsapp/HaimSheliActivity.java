...
public class HaimSheliActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.haim_sheli);
//
...
//        animationDrawable.start();
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(HaimSheliActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("ח") && char2.equals("י") && char3.equals("י") && char4.equals("ם") && char5.equals("ש") && char6.equals("ל") && char7.equals("י")) {
                    done = true;
                    ...
                    Intent intent = new Intent(HaimSheliActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "E4XOMgpFUX4");
