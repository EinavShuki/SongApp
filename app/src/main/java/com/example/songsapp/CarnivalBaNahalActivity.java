...
public class CarnivalBaNahalActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.carnival_ba_nahal);
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(CarnivalBaNahalActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("ק") && char2.equals("ר") && char3.equals("נ") && char4.equals("ב") && char5.equals("ל") && char6.equals("ב") && char7.equals("נ") && char8.equals("ח") && char9.equals("ל")) {
                    done=true;
                    ...
                    Intent intent = new Intent(CarnivalBaNahalActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "Bx7oaO6hP_s");
