...
public class HasakeActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hasake);
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(HasakeActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("ח") && char2.equals("ס") && char3.equals("ק") && char4.equals("ה")) {
                    done=true;
                    ...
                    Intent intent = new Intent(HasakeActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "8TlXK9zk22I");
