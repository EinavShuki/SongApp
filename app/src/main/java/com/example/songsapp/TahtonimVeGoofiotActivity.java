...
public class TahtonimVeGoofiotActivity extends ToastDialogFun implements View.OnClickListener {


    EditText c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tahtonim_ve_goofiot);
...
//        animationDrawable.start();
        ...
        c11.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    ...
                    //moving back to previous editText
                    c11.setOnKeyListener(new View.OnKeyListener() {
                        @Override
                        public boolean onKey(View v, int keyCode, KeyEvent event) {
                            if (keyCode == KeyEvent.KEYCODE_DEL) {
                                c11.setOnKeyListener(new View.OnKeyListener() {
        ...
        c12.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (hasFocus) {
                    ...
                    //moving back to previous editText
                    c12.setOnKeyListener(new View.OnKeyListener() {
                        @Override
                        public boolean onKey(View v, int keyCode, KeyEvent event) {
                            if (keyCode == KeyEvent.KEYCODE_DEL) {
                                c12.setOnKeyListener(new View.OnKeyListener() {
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(TahtonimVeGoofiotActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.clear:
                ...
                c11.setText("");
                c12.setText("");
                l1 = l2 = l3 = l4 = l5 = l6 = l7 = l8 = l9 = l10 = l11 = l12 = false;
                break;
            case R.id.reveal:
                if (oka) {
                    oka = false;
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("א") && char2.equals("י") && char3.equals("ן") && char4.equals("ל") && char5.equals("ך") && char6.equals("מ") && char7.equals("ה") && char8.equals("ל") && char9.equals("ד") && char10.equals("א") && char11.equals("ו") && char12.equals("ג")) {
                    done = true;
                    ...
                    Intent intent = new Intent(TahtonimVeGoofiotActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "iuEKUUTaY6o");
