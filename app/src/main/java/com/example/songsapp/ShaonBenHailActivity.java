...
public class ShaonBenHailActivity extends ToastDialogFun implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shaon_ben_hail);
...
//        animationDrawable.start();
    ...
    private void setBtnClick() {
        MediaPlayer btnClick = MediaPlayer.create(ShaonBenHailActivity.this, R.raw.btn_c);
        btnClick.start();
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.check_btn:
                ...
                if (char1.equals("ש") && char2.equals("ע") && char3.equals("ו") && char4.equals("ן") && char5.equals("ב") && char6.equals("ן") && char7.equals("ח") && char8.equals("י") && char9.equals("ל")) {
                    done=true;
                    ...
                    Intent intent = new Intent(ShaonBenHailActivity.this, IntermediateActivity.class);
                    intent.putExtra("song_id", "xicFLRDaCT0");
